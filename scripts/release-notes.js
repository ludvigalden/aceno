...
async function main() {
    const res = await got("https://api.github.com/repos/ludvigalden/aceno/releases", {
        responseType: "json",
    });
    ...
    // Add compare link
    finalMessage.push(`https://github.com/ludvigalden/aceno/compare/${firstVersion}...${lastVersion}`);
